...
#If I want to connect to HDInsight from outside of edge node:
...
mySparkCluster <- RxSpark(
  ...
  shareDir = myShareDir,
  sshUsername = "sshuser",
  sshHostname = "RServer4Hdi-sehan-ed-ssh.azurehdinsight.net",
  sshSwitches = "", #Need to use -i switch to specify SSH Key
  sshProfileScript = '/etc/profile',
  nameNode = "RServer4Hdi-sehan-ssh.azurehdinsight.net",
  port = 0,
  consoleOutput = TRUE,
  sshClientDir = "C:\\Program Files (x86)\\x2goclient"
)
