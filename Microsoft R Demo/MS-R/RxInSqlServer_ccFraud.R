...
##sqlConnString <- "Driver=SQL Server;Server=???.???.???.???;Database=RevoDB;Uid=ruser;Pwd=P@ssword"
sqlConnString <- "Driver=SQL Server;Server=.\\MYSERVER;Database=RevoDB;Uid=ruser;Pwd=P@ssword"
sqlRowsPerRead = 5000
